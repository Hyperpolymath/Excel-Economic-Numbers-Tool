...
(define-module (excel-economic-numbers-tool meta)
...
(define architecture-decisions
  '((adr-001
     ...
     (status . "accepted")
     (date . "2025-12-15")
     (context . "> Cross-platform Excel/LibreOffice add-in for economic modeling, data analysis, and investigative research")
...
(define development-practices
  '((code-style
     (languages . ("Dockerfile" "JavaScript" "Julia" "Just" "Nix" "ReScript" "Scheme" "Shell" "TypeScript"))
