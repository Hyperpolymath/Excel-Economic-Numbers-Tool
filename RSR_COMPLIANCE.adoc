= RSR Compliance: Excel-Economic-Numbers-Tool
:toc:
:sectnums:

== Overview

This document describes the Rhodium Standard Repository (RSR) compliance status for *Excel-Economic-Numbers-Tool*.
